package com.aliozdemir.kotlinworkmanager
...
class RefreshDatabase(val context: Context, workerParams: WorkerParameters) : Worker(context, workerParams ) {
    ...
    private fun refreshDatabase(myNumber : Int) {
        val sharedPreferences = context.getSharedPreferences("package com.aliozdemir.kotlinworkmanager", Context.MODE_PRIVATE)
