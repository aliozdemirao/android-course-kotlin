package com.aliozdemir.storingdata
...
import com.aliozdemir.storingdata.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedPreferences = this.getSharedPreferences("com.aliozdemir.storingdata", Context.MODE_PRIVATE)
